...
export default function UserPage() {
  ...
  const handleImport = (e) => {
    ...
    reader.onload = (e) => {
      ...
      // Pass header as 1 to treat the first row as the header row
      ...
      const dataAsObjects = jsonData.map(row => ({
        Name: row[0],
        Email: row[1]
      }));

      // Filter out empty objects
      const filteredData = dataAsObjects.filter(obj => obj.Name && obj.Email);

      console.log(filteredData, "jsonData");

      // Set the data into your state
    ...
    <>
      ...
      <Container>
        ...
        >
          ...
          {/* <input type="file" accept=".xls</label>x, .xls" onChange={handleImport} /> */}
